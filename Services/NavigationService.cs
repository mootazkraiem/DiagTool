...
public sealed class NavigationService : ObservableObject
{
    ...
    public NavigationService(
        ...
        ValidationLabViewModel validationLab,
        ...
        VehicleDataService vehicleDataService)
    {
        ...
        homeSection = home;
        Preview = preview;
        Tabs = new ObservableCollection<NavigationItemViewModel>(BuildTabs(dashboard, telemetry, diagnostics, playback, analytics, settings, validationLab, anomalyIntel));
