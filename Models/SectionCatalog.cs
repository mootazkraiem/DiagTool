...
public static class SectionCatalog
{
    private static readonly IReadOnlyDictionary<SectionKey, SectionDescriptor> Descriptors =
        new Dictionary<SectionKey, SectionDescriptor>
        {
            ...
            [SectionKey.ValidationLab] = new(
                SectionKey.ValidationLab,
                "07",
                "Validation Lab",
                "IDS evaluation against ground-truth attack datasets.",
                "Run the frequency-deviation IDS against labelled attack CSV files and measure precision, recall, and F1."),
            [SectionKey.Home] = new(
                SectionKey.Home,
                "00",
                "Home",
            ...
            [SectionKey.AnomalyIntel] = new(
                ...
                "Review detected anomalies with GPT-4o-mini explanations, layer attribution, and mitigation guidance."),
        };
