...
public sealed class MainWindowViewModel : ViewModelBase
{
    ...
    public bool IsTopBarVisible => CurrentSectionKey != SectionKey.Home;
    ...
    public string EmptyStateTitle => VehicleDataService.AppState == Models.AppState.NoDataset
        ? "Waiting for data source."
        : "Connecting to live bus...";

    public string EmptyStateSubtitle => VehicleDataService.AppState == Models.AppState.NoDataset
        ? "Import a CAN log from the Home screen to begin."
        : "Start the backend and connect your CAN interface in Settings.";
