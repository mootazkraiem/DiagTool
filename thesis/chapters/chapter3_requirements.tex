...
\begin{itemize}
    ...
    \item \textbf{NFR7 — Platform.} The desktop client shall run on Windows 10/11 using .NET Framework 4.8 and \gls{wpf}; the backend shall run as a local Python process exposing a \gls{rest} \gls{api} on \texttt{localhost}.
\end{itemize}
